...
contract PBM_PercentageUnpackContract {
    enum TransactionStatus { NONE, REQUESTED, APPROVED, REDEEMED }
    using SafeMath for uint256;

    uint256 public purchaseAmountDecimals = 2;
    uint256 public percentageDecimals = 2;
    ...
    function redeem(address _to, uint256 _pbmID, uint128 _purchaseAmount) public {
    ...
    function approve(address _pbmOwner, uint256 _pbmID, address _to, uint128 _purchaseAmount) public {
